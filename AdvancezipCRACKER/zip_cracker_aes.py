#!/usr/bin/env python3
"""
AES ZIP Password Cracker - Supports WinZIP AES encryption
"""
...
class AESZipCracker:
            ...
            with pyzipper.AESZipFile(zip_file, 'r') as zf:
                ...
                for info in zf.infolist():
                    if self.verbose:
                        ...
                        print(f"[*] AES: {info.is_aes_encrypted}")
                        
        except Exception as e:
            raise ValueError(f"Invalid ZIP file: {e}")
    
    def test_password(self, password):
        """Test if password can extract the AES ZIP file"""
        try:
    ...
    def dictionary_attack(self, wordlist, max_workers=None):
        ...
        print(f"[*] Starting AES dictionary attack with {wordlist}")
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            for i, future in enumerate(as_completed(futures), 1):
                ...
                # Progress update
                if i % 100 == 0 or i == total_passwords:
    ...
    def brute_force_attack(self, min_length=1, max_length=6, charset=None, max_workers=None):
        ...
        print(f"[*] Starting AES brute force attack")
...
def main():
    parser = argparse.ArgumentParser(description='AES ZIP Password Cracker')
    ...
    try:
        cracker = AESZipCracker(args.zip_file, args.verbose)
